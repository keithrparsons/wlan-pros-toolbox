...
const Map<String, List<String>> kToolKeywords = <String, List<String>>{
  ...
  'mobile-traceroute': <String>['tracert', 'hops', 'ttl', 'path', 'route'],
  'ssl-inspect': <String>[
    'certificate',
    'cert',
    'tls',
  ...
  // 'vlsm' moved OFF this entry on 2026-08-02. It used to live here, which
  ...
  // 'summarisation' is the British spelling. It is here as a SEARCH TERM, not
  // as prose: the index exists to match what a user types, and plenty of them
  ...
  'emoji-reference': <String>['emoticons', 'symbols', 'unicode', 'smiley'],
