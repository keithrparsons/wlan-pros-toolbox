...
class CountryPlug {
  ...
  String get typeLabel => 'Type ${types.join(', ')}';
...
const List<CountryPlug> kCountryPlugs = <CountryPlug>[
  ...
  CountryPlug(
    ...
    voltage: '230V',
    frequency: '50Hz',
    aliases: <String>['Czech Republic'],
  ),
  CountryPlug(
    country: 'Denmark',
    types: <String>['C', 'E', 'F', 'K'],
    voltage: '230V',
    frequency: '50Hz',
  ),
  CountryPlug(
  ...
  CountryPlug(
    ...
    voltage: '230V',
    frequency: '50Hz',
    aliases: <String>['Swaziland'],
  ),
  CountryPlug(
    country: 'Ethiopia',
    types: <String>['C', 'E', 'F', 'L'],
    voltage: '220V',
    frequency: '50Hz',
  ),
  CountryPlug(
  ...
  CountryPlug(
    ...
    types: <String>['A', 'B', 'C', 'E', 'F'],
    voltage: '110/220V',
    frequency: '60/50Hz',
    aliases: <String>['Tahiti'],
  ),
  CountryPlug(
    country: 'Gabon',
    types: <String>['C', 'E'],
  ...
  CountryPlug(
    country: 'Myanmar',
    types: <String>['A', 'C', 'D', 'F', 'G', 'I'],
    voltage: '230V',
    frequency: '50Hz',
    aliases: <String>['Burma'],
  ),
  CountryPlug(
    country: 'Namibia',
    types: <String>['D', 'M'],
  ...
  CountryPlug(
    ...
    types: <String>['A', 'B', 'F', 'G'],
    voltage: '230V',
    frequency: '60Hz',
  ),
  CountryPlug(
    country: 'Senegal',
    types: <String>['C', 'D', 'E', 'K'],
    voltage: '230V',
    frequency: '50Hz',
  ),
  CountryPlug(
  ...
  CountryPlug(
    ...
    voltage: '220V',
    frequency: '60Hz',
    aliases: <String>['Korea', 'Republic of Korea'],
  ),
  CountryPlug(
    country: 'Spain',
    types: <String>['C', 'F'],
  ...
  CountryPlug(
    country: 'Thailand',
    types: <String>['A', 'B', 'C', 'O'],
    voltage: '230V',
    frequency: '50Hz',
  ),
  CountryPlug(
    country: 'Timor-Leste',
    types: <String>['C', 'E', 'F', 'I'],
    voltage: '220V',
    frequency: '50Hz',
    aliases: <String>['East Timor'],
  ),
  CountryPlug(
    country: 'Togo',
    types: <String>['C', 'E'],
  ...
  CountryPlug(
    ...
    voltage: '230V',
    frequency: '50Hz',
    aliases: <String>['UAE', 'Emirates', 'Dubai', 'Abu Dhabi'],
  ),
  CountryPlug(
...
List<CountryPlug> searchCountryPlugs(String query) {
  ...
  ranked.sort((_Ranked a, _Ranked b) {
    ...
    return a.entry.country.toLowerCase().compareTo(
      b.entry.country.toLowerCase(),
    );
  });
