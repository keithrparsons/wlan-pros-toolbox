...
/// `SystemUptimeBridge` on iOS.
///
/// device_info_plus already provides the model and total memory on iOS, so the
...
/// property read, mirroring the macOS `SystemInfoChannel`.
///
