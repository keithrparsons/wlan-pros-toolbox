...
//
// Cases 2 and 3 covered the Dual Orb download button and its private _LinkRow
// rows. Both were removed on 2026-08-21 with the Dual Orb tool itself. Case 1
// still covers the ElevatedButton.icon ring that case 2 duplicated. NOTE the
// real coverage loss: _LinkRow was this file's only FocusableActionDetector
// subject, so the §8.3 ring on that widget class is now untested here even
// though app_toggle, tool_help_footer and reference_drilldown all rely on it.
//
