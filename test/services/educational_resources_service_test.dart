...
// REAL bundled asset to prove all 39 entries parse and group into the 7 topics.
...
void main() {
  ...
  group('real bundled asset', () {
    test('parses the 39 curated entries into the 7 topic groups', () {
      ...
      // existing 7 topics, so the group count is unchanged.
